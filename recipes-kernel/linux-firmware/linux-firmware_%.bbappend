...
SRC_URI:append:stm32mpcommon = " file://brcmfmac43362-sdio.txt "
SRC_URI:append:stm32mpcommon = " file://brcmfmac43430-sdio.bin "
SRC_URI:append:stm32mpcommon = " file://brcmfmac43430-sdio.clm_blob "
#SRC_URI:append:stm32mpcommon = " git://e.coding.net/lichang70/linux-fw-myir.git;protocol=https;branch=master "
...
RRECOMMENDS_${PN}-bcm43430:append:stm32mpcommon += "${@bb.utils.contains('DISTRO_FEATURES', 'systemd', 'wifi-suspend', '', d)}"
